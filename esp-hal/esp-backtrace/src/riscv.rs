...
#[cfg(all(feature = "defmt", feature = "exception-handler"))]
impl defmt::Format for TrapFrame {
...
// it needed otherwise sometimes an address was optimised out
// by the compiler in backtrace_internal loop
#[inline(never)]
