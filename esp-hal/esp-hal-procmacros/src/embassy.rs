...
pub(crate) mod main {
    ...
    pub fn main() -> TokenStream {
        quote! {
            // this decorate/proc-macro is the only difference between
            // the original embassy_executor::main and esp_hal_embassy::main procedural macros
            // the original main here gives #[#entry]
            #[esp_hal::entry]
            fn main() -> ! {
