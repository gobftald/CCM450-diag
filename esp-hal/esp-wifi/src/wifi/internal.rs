...
static g_wifi_osi_funcs: wifi_osi_funcs_t = wifi_osi_funcs_t {
    ...
    _recursive_mutex_create: None,                  // 76 Some(recursive_mutex_create),
    _mutex_delete: None,                            // 80 Some(mutex_delete),
    _mutex_lock: None,                              // 84 Some(mutex_lock),
    ...
    _task_get_current_task: None,                   // 164 Some(task_get_current_task),
    _task_get_max_priority: None,                   // 168 Some(task_get_max_priority),
    _malloc: None,                                  // 172 Some(malloc),
