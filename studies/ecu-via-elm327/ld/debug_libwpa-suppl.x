.libwpa-suppl : ALIGN(4)
{
    ...
    /* wpa_auth.c.obj */
        ...
        *(.text.wpa_deinit)
        *(.text.wpa_ap_remove)
        *(.text.wpa_auth_pmksa_clear_cb)
        *(.text.wpa_auth_for_each_sta)
        *(.text.wpa_group_setkeys)
        *(.text.wpa_group_update_sta)
    ...
    /* esp_common.c.obj */
        ...
        *(.text.esp_supplicant_unset_all_appie)
        *(.text.map_wifi_config_sae_pwe_to_supp)
    ...
    /* esp_hostap.c.obj */
        ...
        *(.text.hostap_new_assoc_sta)
        *(.text.wpa_status_to_reason_code)
